...
namespace Geofencing
{
	public static class Constants
	{
		...
		public const float GEOFENCE_RADIUS_IN_METERS = 100;

		public static readonly Dictionary<string, LatLng> BAY_AREA_LANDMARKS = new Dictionary<string, LatLng> {
			{ "SFO", new LatLng (50.91522615396107, 3.6511629274683446) },
			{ "GOOGLE", new LatLng (50.91522615396107, 3.6511629274683446) }
		};
	}
}
