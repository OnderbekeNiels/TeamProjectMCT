    ...
    public partial class MainPage : ContentPage
    {
       ...
       bool raceGoing = true;
        ...
        public async Task TriggerAsync()
        {
            ...
            CrossGeofence.Current.StartMonitoring(new GeofenceCircularRegion("TestPoint", 50.9150914, 3.6513881, 0.5) { ShowEntryNotification = true, NotificationEntryMessage = "entered line", ShowStayNotification = true, NotificationStayMessage="je bent er nog", StayedInThresholdDuration = TimeSpan.FromSeconds(10) });
        }
